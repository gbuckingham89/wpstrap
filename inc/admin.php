<?php
/** 
 * Add "Styles" dropdown menu
 */   
add_filter( 'mce_buttons_2', 'wpstrap_styles_menu' );  
  
function wpstrap_styles_menu( $buttons ) {  
    array_unshift( $buttons, 'styleselect' );  
    return $buttons;  
}  
  
/** 
 * Add styles/classes to the "Styles" dropdown menu
 */   
